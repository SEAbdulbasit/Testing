package com.example.barcodescannernew.adapter
...
//        this.barcodes=barcodes
    ...
    override fun onBindViewHolder(holder: BarcodeViewHolder, position: Int) {
        ...
        holder.textCopy.setOnClickListener {
            Toast.makeText(holder.itemView.context, "You Clicked $barcodeValue", Toast.LENGTH_SHORT).show()
        }
        holder.textCopy.setOnClickListener {
        ...
        holder.barcodeValue.setOnLongClickListener {
            AlertDialog.Builder(holder.itemView.context)
                .setCancelable(false)
                .setTitle("Deleting Barcode")
                .setMessage("Do you want to delete the barcode value?")
